...
def parseArguments():
	...
	parser.add_argument('--domain-checks', help="Enable domain checks to avoid infinity errors", default=False, action='store_true')
...
if __name__ == "__main__":
	...
	print("LEVEL_TOP: Optimizer cells : {num_calls}".format(num_calls=Globals.ibexID))
	...
	print("LEVEL_TOP: Full_time : {full_time}".format(full_time=full_time))
	print("LEVEL_TOP: ABSOLUTE_ERROR :", Globals.abs_error)
	...
	if Globals.domain_checks:
		print("LEVEL_TOP: Domain check found these constraints to avoid infinity:")
